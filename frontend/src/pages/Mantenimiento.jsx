...
function Mantenimiento() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      <h1 className="text-3xl font-bold mb-2">Solicitar Mantenimiento / Garantía</h1>
      <p className="text-gray-500 mb-8">Completa el formulario y nuestro equipo técnico te atenderá.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              { value: 'correctivo', label: '🛠️ Mantenimiento Correctivo' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              name="tipo_puerta"
              placeholder="Puerta corrediza, levadiza..."
              onChange={handleChange}
              required
              className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:border-yellow-400"
            />
