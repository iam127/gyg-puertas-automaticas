...
const servicios = [
  { icono: <FaHammer size={22} />, titulo: 'Fabricación', desc: 'Fabricamos puertas a medida en madera, metal y paneles importados según tus especificaciones.' },
  { icono: <FaWrench size={22} />, titulo: 'Instalación', desc: 'Instalamos todo tipo de puertas automáticas con materiales de primera calidad y acabados perfectos.' },
  { icono: <FaTools size={22} />, titulo: 'Mantenimiento Preventivo', desc: 'Realizamos revisiones periódicas para evitar fallas y prolongar la vida útil de tu puerta.' },
  { icono: <FaSearchPlus size={22} />, titulo: 'Mantenimiento Correctivo', desc: 'Diagnosticamos y reparamos cualquier falla en tu puerta automática de forma rápida y efectiva.' },
  { icono: <FaShieldAlt size={22} />, titulo: 'Garantía y Repuestos', desc: 'Contamos con stock de repuestos originales para todas las marcas que trabajamos.' },
  { icono: <FaBolt size={22} />, titulo: 'Atención de Emergencias', desc: 'Disponibles las 24 horas del día para atender cualquier emergencia con tu puerta automática.' },
]
    ...
    <div>
      ...
      <section className="bg-gray-900 text-white py-24 px-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          <span className="text-yellow-400 font-bold text-sm uppercase tracking-wider">Conócenos</span>
          <h1 className="text-5xl font-bold mt-2 mb-4">Sobre <span className="text-yellow-400">Nosotros</span></h1>
          <p className="text-gray-300 max-w-2xl mx-auto text-lg">
            Desde 2016 brindando soluciones en puertas automáticas para hogares y empresas en toda Lima.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold mt-2 mb-6 text-gray-900">Quiénes somos</h2>
              <p className="text-gray-500 mb-4 leading-relaxed">
                GyG Puertas Automáticas es una empresa peruana fundada en 2016, especializada en la fabricación, instalación y mantenimiento de puertas automáticas para uso residencial, comercial e industrial.
              </p>
              <p className="text-gray-500 mb-4 leading-relaxed">
                A lo largo de estos años hemos atendido a cientos de clientes en todos los distritos de Lima Metropolitana, ofreciendo soluciones personalizadas adaptadas a las necesidades y presupuesto de cada cliente.
              </p>
              <p className="text-gray-500 leading-relaxed">
                Trabajamos con motores y equipos importados de las marcas más reconocidas del mundo, garantizando durabilidad, seguridad y confiabilidad en cada instalación.
              </p>
              <div className="mt-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { numero: '2016', label: 'Año de fundación' },
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mt-2">Misión, Visión y Valores</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-900 rounded-2xl p-8 shadow-sm hover:shadow-md transition border-b-4 border-gray-700">
              ...
              <p className="text-gray-400 leading-relaxed">
                Ser la empresa líder en automatización de puertas y accesos en el Perú, reconocida por la excelencia en nuestros productos, innovación tecnológica y el compromiso con la satisfacción de nuestros clientes.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition border-b-4 border-yellow-400">
              <div className="w-12 h-12 bg-yellow-400 rounded-2xl flex items-center justify-center font-bold text-gray-900 text-xl mb-5">V</div>
      ...
      <section className="py-20 px-4 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto text-center">
          <span className="text-yellow-400 font-bold text-sm uppercase tracking-wider">Dónde estamos</span>
          ...
          <div className="bg-gray-800 rounded-2xl p-10 max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 mb-8 leading-relaxed">
              Desde Chorrillos hasta Carabayllo, desde Ate hasta La Perla. Llegamos a cualquier distrito de Lima para instalarte o darte mantenimiento a tu puerta automática.
            </p>
